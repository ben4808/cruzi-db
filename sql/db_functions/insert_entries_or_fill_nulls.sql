...
RETURNS void AS $$
BEGIN
  INSERT INTO entry ("entry", base_form, lang, "length", display_text, entry_type, familiarity_bucket, familiarity_score, quality_score, idiomacity_score, unity_bucket, unity_score, loading_status)
  SELECT
    elem->>'entry',
